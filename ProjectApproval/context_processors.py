...
from ProjectApproval import PROJECT_STATUS_CAN_FINISHED
...
def expose_consts(request):
    consts = {
        ...
        'PROJECT_STATUS_CAN_ENDED': PROJECT_STATUS_CAN_ENDED,
        'PROJECT_STATUS_CAN_FINISHED': PROJECT_STATUS_CAN_FINISHED
    }
    return consts
